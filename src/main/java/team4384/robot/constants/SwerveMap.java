...
public class SwerveMap {
    ...
    public static final double maxSlowTeleSpeed = 0.23; //TODO: This must be tuned to specific robot
    /** Radians per Second */
    public static final double maxAngularVelocity = 0.5; //TODO: This must be tuned to specific robot
    public static final double maxRotSpeed = .5;
    ...
    public static final class FL0 { //TODO: This must be tuned to specific robot
        ...
        public static final Rotation2d angleOffset = Rotation2d.fromDegrees(228.603515625);
    ...
    public static final class FR1 { //TODO: This must be tuned to specific robot
        ...
        public static final Rotation2d angleOffset = Rotation2d.fromDegrees(247.41210937500003);
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class BL2 { //TODO: This must be tuned to specific robot
        ...
        public static final Rotation2d angleOffset = Rotation2d.fromDegrees(339.9609375);
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class BR3 { //TODO: This must be tuned to specific robot
        ...
        public static final Rotation2d angleOffset = Rotation2d.fromDegrees(220.565625);
        public static final SwerveModuleConstants constants =
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
}
